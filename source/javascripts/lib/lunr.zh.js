...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
     ...
     * like Node.
     */
    module.exports = factory(require('segmentit'))
  } else {
  ...
  return function (lunr, nodejiebaDictJson) {
    ...
    lunr.zh.tokenizer = function (obj) {
      ...
      this.segmentit.doSegment(str, true).forEach(function (seg) {
      ...
      var result = tokens.map(function (token, index) {
        if (isLunr2) {
